	...
	$(".js-lightbox").on("click", function (e) {
		...
		if (type === "video") {
			...
			lightboxContent.html(
				'<div class="lightbox-video-wrapper"><iframe src="' +
					src +
					'?autoplay=1" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen></iframe></div>'
			);
		} else if (type === "image") {
